	...
	<div class="container">
		<div class="row clearfix">
			<div class="background">
				<img src="static/images/tick.png" class="tick_img"/>&nbsp;<span class="title_color title_size">You have commented the product successfully</span>
				<br/><br/><br/>
				<ul>
			      <!-- <li><span>Comment Succeed!</span></li> -->
