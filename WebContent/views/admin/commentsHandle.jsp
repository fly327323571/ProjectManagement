...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <div class="container">
     ...
     <div><span style="color:#FF4400;font-size:30px;font-weight:bolder"">COMMENT HANDLE</span></div>
   ...
   <table  class="table">
       ...
       <tbody>
           <c:forEach items="${CommentsList}" var="person" varStatus="status">
	     <tr>          	    
          ...
          <td>
     	    <a href="admin/odiumDetial?commentsId=${person.commentsId}">&nbsp;&nbsp;Detial</a>
          </td>       	
        </tr>
        </c:forEach>
       </tbody>
