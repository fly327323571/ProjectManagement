...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    <base href="<%=basePath%>">
    <title>ParknShop--search Income</title>  
    <meta charset="utf-8">
  ...
  <div class="container">
  	<nav class="navbar navbar-default" role="navigation">
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<form action="admin/searchIncome" class="navbar-form navbar-right" method="post">
	...
	<div class="result">
     ...
     <table  class="table">
          <thead>
           ...
           <tbody >
                  <c:forEach items="${array}" var="share" varStatus="status">
            	   <tr>          	    
                      <td>${status.index+1 }</td>
                      <td>${share.shop.shopId}</td>
                      <td>${share.shop.shopName}</td>
                      <td>${share.turnover}</td>
                      <td>${share.shareMoney}</td>
                      <td>${share.rate}%</td>
