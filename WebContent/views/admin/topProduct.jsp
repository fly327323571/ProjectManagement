...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <title>ParknShop--Top Product</title>
	...
	<link rel="stylesheet" type="text/css" href="static/css/admin/topProduct.css" />
  ...
  <body>
  		...
  		<div class="topShop-main-container">
	  		<nav class="navbar navbar-default navbar-style" role="navigation">
				...
				<div class="add_product">
					<button class="btn btn-style add-product">add product</button>
				</div>
				<form class="navbar-form navbar-right" role="search">
					<div class="form-group">
						<input id="product-name" class="form-control" placeholder="product name" type="text">
					</div>
					<button id="search" class="btn btn-style" type="button">Search</button>
				</form>
			</nav>
			<div class="topProduct-list">
				<table id="topProduct-list" class="table"></table>
				<nav class="page">
		...
		<script type="text/template" id="detailTmpl">
			<div class="dialog-block">
				<p class="dialog-block-title">Product Advertisement<p>
				<div class="clearfix bs-callout bs-callout-warning">
					<form class="form-horizontal" style="float: left;width: 80%;">
    					<div class="form-group">
							<label class="col-sm-3 control-label" style="line-height: 20px;padding-bottom: 8px;">Product id</label>
	 						<div class="col-sm-7">
	  							<input class="form-control productId" name="title" type="text" autofocus="autofocus" style="background-color: white;cursor: text;">
	 						</div>
    					</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label" style="line-height: 20px;padding-bottom: 8px;">Product Name</label>
	 						<div class="col-sm-7">
	  							<input class="form-control" id="productad-name" name="productad-name" type="text" autofocus="autofocus" style="background-color: white;cursor: text;">
	 						</div>
    					</div>
 ...
 <script src="static/js/admin/topProduct.js"></script>
 <script src="static/js/admin/topProductConfig.js"></script>
</html>
