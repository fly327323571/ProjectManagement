...
<h4 class="intro">Apply Homepage Product Advertisement($10/day)</h4>
</div>
</div>
<div class="form-horizontal" style="float:left;width: 60%;">
<div class="form-group">
 <label class="col-sm-3 control-label" for="rateDay">Product</label>
 <div class="col-sm-7" >
<select id="product" name="product" class="form-control">
<option value="-1" style="display:none;">select your Products</option>
<c:forEach var="product" items="${products }">
<option value="${product.commodityNo }">${product.commodityName }</option></c:forEach>
</select>
</div>
</div>
</div>
...
<script src="static/js/shop/ApplyCommodityAdvertise.js"></script>
<script src="static/js/shop/ApplyCommodityAdvertiseConfig.js"></script>
